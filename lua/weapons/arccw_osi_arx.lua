...
SWEP.Trivia_Desc= "Make no compromises with ergonomics. This is YOUR truly modern (tm) fighting rifle (tm) destine to reunite (tm) the Mediterranian (tm) under a single flag (tm). All rights reserved."
