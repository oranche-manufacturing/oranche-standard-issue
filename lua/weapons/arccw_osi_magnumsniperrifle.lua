...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        SoundTable = {
                        ...
                        {s = "weapons/arccw_osi/heavy bolt action/bolt_up.wav", 	t = 0.05},
                        {s = "weapons/arccw_osi/heavy bolt action/bolt_back.wav", 	t = 0.13},
                        {s = "weapons/arccw_osi/heavy bolt action/bolt_forward.wav", t = 0.37},
                        {s = "weapons/arccw_osi/heavy bolt action/bolt_down.wav", 	t = 0.58},
