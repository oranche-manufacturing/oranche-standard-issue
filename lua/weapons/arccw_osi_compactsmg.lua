...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
						...
						{s = "weapons/arccw_osi/compact smg/csmg2_magin.wav", 	            t = 1.5},
	...
	["reload_empty"] = {
        ...
        SoundTable = {
						...
						{s = "weapons/arccw_osi/cloth1.wav", 	                    t = 1.2},
						{s = "weapons/arccw_osi/compact smg/csmg2_magin.wav", 	            t = 1.5},
						{s = "weapons/arccw_osi/compact smg/csmg2_chback.wav", 	t = 2.0},
						{s = "weapons/arccw_osi/compact smg/csmg2_chamber.wav", 	t = 2.35},
