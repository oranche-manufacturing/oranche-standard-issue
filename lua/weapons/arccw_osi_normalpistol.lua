...
SWEP.DistantShootSound = "weapons/arccw_osi/normal pistol/fire_dist.wav"
...
SWEP.Animations = {
    ...
    ["draw"] = {
        ...
        Time = nil,
        SoundTable = {
            {s = "weapons/arccw_osi/normal pistol/raise.wav",     t = 0},
        },
    },
    ["draw_empty"] = {
    ...
    ["holster"] = {
        ...
        Time = nil,
        SoundTable = {
            {s = "weapons/arccw_osi/normal pistol/lower.wav",     t = 0},
        },
    },
    ["holster_empty"] = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
                        ...
                        {s = "weapons/arccw_osi/magpull.wav", 	                    t = 0.5},
						{s = "weapons/arccw_osi/cloth1.wav", 	                    t = 0.6},
                        {s = "weapons/arccw_osi/pst_magdrop_poly.wav", 	                    t = 0.8},
						{s = "weapons/arccw_osi/normal pistol/magin.wav", 	t = 0.85},
						{s = "weapons/arccw_osi/cloth3.wav", 	                    t = 1.3},
					},
    },
	["reload_empty"] = {
        ...
        SoundTable = {
                        ...
                        {s = "weapons/arccw_osi/pst_magdrop_poly.wav", 	                    t = 0.8},
						{s = "weapons/arccw_osi/normal pistol/magin.wav", 	t = 0.85},
						{s = "weapons/arccw_osi/normal pistol/chamber.wav", 	t = 1.4},
